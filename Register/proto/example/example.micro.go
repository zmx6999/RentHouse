...
/*
Package go_micro_srv_Register is a generated protocol buffer package.
...
func (c *exampleService) Register(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *exampleHandler) Register(ctx context.Context, in *Request, out *Response) error {
