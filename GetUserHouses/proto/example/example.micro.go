...
/*
Package go_micro_srv_GetUserHouses is a generated protocol buffer package.
...
func (c *exampleService) GetUserHouses(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *exampleHandler) GetUserHouses(ctx context.Context, in *Request, out *Response) error {
