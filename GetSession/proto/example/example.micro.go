...
func (c *exampleService) GetSession(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *exampleHandler) GetSession(ctx context.Context, in *Request, out *Response) error {
