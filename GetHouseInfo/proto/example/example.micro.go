...
/*
Package go_micro_srv_GetHouseInfo is a generated protocol buffer package.
...
func (c *exampleService) GetHouseInfo(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *exampleHandler) GetHouseInfo(ctx context.Context, in *Request, out *Response) error {
