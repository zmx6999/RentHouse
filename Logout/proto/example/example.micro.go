...
/*
Package go_micro_srv_Logout is a generated protocol buffer package.
...
func (c *exampleService) Logout(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *exampleHandler) Logout(ctx context.Context, in *Request, out *Response) error {
